...
foreach ($result as $row) {
    ...
    $sub_array[] = '<button type="button" name="explore" id="' . $row["id"] . '" class="w-100 h-100 explore" style="background: none; border: none; margin: auto; text-align: center;" title="Profil korisnika" ><a href="user_profile.php?var=' . $row["id"] . '"><i class="far fa-file" style="color: black;"></i></a></button>';
